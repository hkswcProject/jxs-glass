    ...
    <div :style="'overflow:auto;-webkit-overflow-scrolling:touch;height:'+divHeight">
      ...
      <ul v-if="orderData.obligationsAmount">
		...
		<div class="btmBar" v-if="orderData.orderStatus==0">
			<div class="btnWrap" >
        <a href="javascript:void(0);" @click="cancelOrder"class="cancelBtn">取消订单</a>
				<a href="javascript:void(0);" @click="goPay" class="paymentBtn-mid">去支付</a>
			</div>
    </div>
    <div class="btmBar" v-if="orderData.orderStatus==10">
      <div class="btnWrap" >
        <a href="javascript:void(0);" @click="delOrder" class="delBtn">删除订单</a>
      </div>
    </div>
